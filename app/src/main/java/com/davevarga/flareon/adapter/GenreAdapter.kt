...
import com.davevarga.flareon.databinding.LayoutGenreListItemBinding
import com.davevarga.flareon.models.Genre
...
class GenreAdapter(var items: List<Genre>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GenreViewHolder {
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            com.davevarga.flareon.R.layout.layout_genre_list_item,
            parent,
            false
        )
